...
const iconPaths = {
  ...
  vk: "M23.5,7.5c0.1-0.4,0-0.8-0.6-0.8h-2.1c-0.5,0-0.8,0.3-1,0.6c0,0-1.2,2.8-2.9,4.6c-0.6,0.6-0.9,0.8-1.2,0.8c-0.1,0-0.2-0.2-0.2-0.6V7.5c0-0.5-0.2-0.8-0.6-0.8H11c-0.3,0-0.5,0.2-0.5,0.4c0,0.4,0.6,0.5,0.6,1.7v2.6c0,0.6-0.1,0.7-0.3,0.7c-0.8,0-2.7-2.9-3.8-6.2C6.9,5.3,6.6,4.9,6.1,4.9H3.9C3.5,4.9,3.3,5.2,3.3,5.6c0,0.6,0.8,3.7,3.7,7.1c2,2.5,4.8,3.9,7.3,3.9c1.5,0,1.7-0.3,1.7-0.8c0-2.3-0.1-2.5,0.5-2.5c0.3,0,0.8,0.2,1.9,1.3c1.3,1.3,1.5,1.9,2.3,1.9h2.1c0.6,0,0.9-0.3,0.7-0.9c-0.2-0.6-0.9-1.5-1.9-2.6c-0.5-0.5-1.2-1.1-1.4-1.3c-0.3-0.2-0.2-0.4,0-0.8C22.8,9.5,23.4,7.9,23.5,7.5z"
} as const;

const SocialIcon: React.FC<IconProps> = ({ name, size = 24, color = '#0A2463' }) => {
  return (
    <svg
      width={size}
      height={size}
